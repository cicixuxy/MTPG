...
* If you want to generate descriptions by yourself, you should download BAID database[BAID](https://github.com/Dreemurr-T/BAID) and use the domain-specific MLLM called GalleryGPT to generate.
